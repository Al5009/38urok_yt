...
<body>
	<?php 
	    ...
	    $query = mysqli_query($con, "SELECT * FROM users INNER JOIN videos ON users.id = videos.xz WHERE users.id = {$_GET['id']}");
			...
			<div class="col-10" style="height: 500px">
				...
				<div class="col-4">
					<form action="update.php" method="GET">				
						<input type="name" name="name" class="form-control" value="<?php echo $stroka['name'] ?>">
						<input type="email" name="email" class="form-control" value="<?php echo $stroka['email'] ?>">
						<input type="phone" name="phone" class="form-control" value="<?php echo $stroka['phone'] ?>">
						<input type="phone" name="phone" class="form-control d-none" value="<?php echo $stroka['id'] ?>">
