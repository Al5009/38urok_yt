...
<body>
	<div class="col-4 mx-auto mt-5">
		...
		<div class="col-9 bg-light mx-auto pt-5 shadow-sm mb-5" style="height: 400px">
			...
			<div class="col-12 mx-auto">
				<form action="login.php" method="POST">
					...
					<button class="form-control mt-2 bg-primary text-white">Далее</button>
					<p style="color: red;"><?php echo $_GET["lol"] ?></p>
				</form>				
